...
var lyricsData = [
  ...
  { text: "She takes me away to that special place", time: 45 },
  { text: "And if I stared too long", time: 53 },
  { text: "I'd probably break down and cry", time: 56 },
  { text: "Whoa, oh-oh", time: 61 },
  { text: "Sweet child o' mine", time: 64 },
  { text: "Whoa, oh-oh-oh", time: 69 },
  { text: "Sweet love of mine", time: 71 },
  ...
  { text: "And see an ounce of pain", time: 103 },
  { text: "Her hair reminds me of a warm, safe place", time: 107 },
  { text: "Where as a child I'd hide", time: 112 },
  { text: "And pray for the thunder and the rain", time: 115 },
  { text: "To quietly pass me by", time: 119 },
  { text: "Whoa oh, sweet child of mine", time: 122 },
  { text: "Whoa-whoa, oh-oh, oh-oh", time: 129 },
  ...
  { text: "Oh, where do we go now?", time: 224 },
